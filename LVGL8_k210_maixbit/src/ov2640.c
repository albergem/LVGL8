...
const uint8_t ov2640_config[][2] = {
...
#if BOARD_AIRV
    {0x04, 0xD8},  // 是否水平翻转 D8 airv r3 back
#else
    {0x04, 0x58},  //
#endif
    ...
    {0x63, 0x00}, {0x46, 0x22}, {0x0c, 0x3c}, {0x61, 0x70}, {0x62, 0x80},
    {0x7c, 0x05}, {0x20, 0x80}, {0x28, 0x30}, {0x6c, 0x00}, {0x6d, 0x80},
    {0x6e, 0x00}, {0x70, 0x02}, {0x71, 0x94}, {0x73, 0xc1}, {0x3d, 0x34},
    {0x5a, 0x57}, {0x12, 0x40}, {0x17, 0x11}, {0x18, 0x43}, {0x19, 0x00},
    {0x1a, 0x4b}, {0x32, 0x09}, {0x37, 0xc0}, {0x4f, 0xca}, {0x50, 0xa8},
    {0x5a, 0x23}, {0x6d, 0x00}, {0x3d, 0x38}, {0xff, 0x00}, {0xe5, 0x7f},
    ...
    {0x97, 0x98}, {0x97, 0x80}, {0x97, 0x00}, {0x97, 0x00}, {0xc3, 0xed},
    ...
    {0xb2, 0x0f}, {0xc4, 0x5c}, {0xc0, 0x64}, {0xc1, 0x4b}, {0x8c, 0x00},
    {0x86, 0x3d}, {0x50, 0x00}, {0x51, 0xC8}, {0x52, 0x96}, {0x53, 0x00},
    {0x54, 0x00}, {0x55, 0x00}, {0x5a, 0x50}, {0x5b, 0x3C}, {0x5c, 0x00},
    {0xd3, 0x02}, {0xc3, 0xed}, {0x7f, 0x00}, {0xda, 0x08},  //
    {0xe5, 0x1f}, {0xe1, 0x67}, {0xe0, 0x00}, {0xdd, 0x7f}, {0x05, 0x00},
    {0xff, 0x00}, {0xe0, 0x04}, {0x5a, 0x50}, {0x5b, 0x3c}, {0x5c, 0x00},
    {0xe0, 0x00}, {0x00, 0x00}};
...
int ov2640_init(void) {
  ...
  for (index = 0; ov2640_config[index][0]; index++)
    dvp_sccb_send_data(OV2640_ADDR, ov2640_config[index][0],
                       ov2640_config[index][1]);
  return 0;
}
